...
type (
	lotteryModel interface {
		Insert(ctx context.Context, data *Lottery, opts ...Option) (sql.Result, error)
		FindOne(ctx context.Context, id int64) (*Lottery, error)
		Update(ctx context.Context, data *Lottery, opts ...Option) error
...
func (m *defaultLotteryModel) Trans(ctx context.Context, fn func(context.Context, sqlx.Session) error) error {
	return m.TransactCtx(ctx, fn)
}

func (m *defaultLotteryModel) Delete(ctx context.Context, id int64, opts ...Option) error {
	// 1. 解析 Options
	var o options
...
func (m *defaultLotteryModel) Insert(ctx context.Context, data *Lottery, opts ...Option) (sql.Result, error) {
	// 1. 解析 Options
	var o options
	for _, opt := range opts {
		opt(&o)
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if o.Session != nil {
			return o.Session.ExecCtx(ctx, query, data.UserId, data.Name, data.Thumb, data.PublishTime, data.JoinNumber, data.Introduce, data.AwardDeadline, data.IsSelected, data.AnnounceType, data.AnnounceTime, data.DelState, data.DeleteTime, data.IsAnnounced, data.SponsorId, data.IsClocked, data.ClockTaskId)
		}
...
func (m *defaultLotteryModel) Update(ctx context.Context, data *Lottery, opts ...Option) error {
	// 1. 解析 Options
	var o options
	for _, opt := range opts {
		opt(&o)
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if o.Session != nil {
			return o.Session.ExecCtx(ctx, query, data.UserId, data.Name, data.Thumb, data.PublishTime, data.JoinNumber, data.Introduce, data.AwardDeadline, data.IsSelected, data.AnnounceType, data.AnnounceTime, data.DelState, data.DeleteTime, data.IsAnnounced, data.SponsorId, data.IsClocked, data.ClockTaskId, data.Id)
		}
